...
Learn more about Agent Skills in the Claude Code documentation.
...
Skills can also come from [Claude Code plugins](../02-reference/plugins.md). Plugins may bundle Skills that are automatically available when the plugin is installed. These Skills work the same way as personal and project Skills.
...
**Recommended approach**: Distribute Skills through [plugins](../02-reference/plugins.md).
...
For complete instructions, see the [plugins guide](../02-reference/plugins.md) for details on adding Skills to your plugin.
...
- **[Plugins](../02-reference/plugins.md)** - Create and distribute plugins with bundled Skills
- **[Plugins Marketplace](../02-reference/plugins-marketplace.md)** - Discover and share plugins with the community
- **[Sub-Agents](../02-reference/sub-agents.md)** - Learn about Claude Code's specialized agent system
- **[Slash Commands](../02-reference/slash-commands.md)** - User-invoked commands vs model-invoked Skills