...
<Tip>
  For complete technical specifications and schemas, see [Plugins reference](plugins-reference.md). For marketplace management, see [Plugin marketplaces](plugins-marketplace.md).
</Tip>

Plugins let you extend Claude Code with custom functionality that can be shared across projects and teams. Install plugins from [marketplaces](plugins-marketplace.md) to add pre-built commands, agents, hooks, Skills, and MCP servers, or create your own to automate your workflows.
...
For detailed marketplace management including Git repositories, local development, and team distribution, see [Plugin marketplaces](plugins-marketplace.md).
...
For complete instructions including configuration examples, marketplace setup, and rollout best practices, see [Configure team marketplaces](plugins-marketplace.md#how-to-configure-team-marketplaces).
...
Plugins can include [Agent Skills](../01-guides/agent-skills.md) to extend Claude's capabilities. Skills are model-invoked—Claude autonomously uses them based on the task context.
...
For complete Skill authoring guidance, see [Agent Skills](../01-guides/agent-skills.md).
...
<Note>
  **For multiple plugins**: Organize plugins in subdirectories like `./plugins/plugin-name` and update your marketplace.json accordingly. See [Plugin sources](plugins-marketplace.md#plugin-sources) for organization patterns.
</Note>
...
3. **Use validation and debugging tools**: See the debugging and development tools documentation for CLI commands and troubleshooting techniques
...
<Note>
  For complete technical specifications, debugging techniques, and distribution strategies, see [Plugins reference](plugins-reference.md.md).
</Note>
...
- **Create your first marketplace**: [Plugin marketplaces guide](plugins-marketplace.md)
- **Advanced components**: Dive deeper into specific plugin components:
  ...
  - [Hooks](../01-guides/hooks.md) - Event handling and automation
  - [MCP](../01-guides/integration/mcp.md) - External tool integration
...
- [Plugin marketplaces](plugins-marketplace.md) - Creating and managing plugin catalogs
...
- Agent Skills - Extend Claude's capabilities
- [Hooks](../01-guides/hooks.md) - Automating workflows with event handlers
- [MCP](../01-guides/integration/mcp.md) - Connecting to external tools and services
