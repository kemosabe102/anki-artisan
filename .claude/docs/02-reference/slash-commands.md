...
| `/permissions`            | View or update [permissions](../01-guides/integration/iam.md#configuring-permissions)                                                                     |
...
[Plugins](plugins.md) can provide custom slash commands that integrate seamlessly with Claude Code. Plugin commands work exactly like user-defined commands but are distributed through [plugin marketplaces](plugins-marketplace.md).
...
When configuring [permissions for MCP tools](../01-guides/integration/iam.md#tool-specific-permission-rules), note that **wildcards are not supported**:
...
The `SlashCommand` tool allows Claude to execute [custom slash commands](#custom-slash-commands) programmatically
...
Learn more about [Agent Skills](../01-guides/agent-skills.md).

## Project-specific commands

This section documents custom slash commands specific to this project.
...
**Arguments**: `<command-name | command-path | --all | --optimize command-name>`

**Model**: opus

**Phases**: P0:VALIDATE → P1:DISCOVER → P2:COLLECT → P3:SYNTHESIZE → P4:PRE-MORTEM → P5:RECOMMEND → P6:REPORT → P7:DELEGATION → P8:SCAMPER

**Usage Examples**:
- `/analyze-command git` - Analyze the git command
- `/analyze-command --optimize implement` - Analyze with SCAMPER optimization
- `/analyze-command --all` - Analyze all commands
...
- [Identity and Access Management](../01-guides/integration/iam.md) - Complete guide to permissions, including MCP tool permissions
- Interactive mode - Shortcuts, input modes, and interactive features
- CLI reference - Command-line flags and options
- [Settings](settings.md) - Configuration options
- [Memory management](../01-guides/memory.md) - Managing Claude's memory across sessions