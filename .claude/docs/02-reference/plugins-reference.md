...
<Tip>
  For hands-on tutorials and practical usage, see [Plugins](plugins.md). For plugin management across teams and communities, see [Plugin marketplaces](plugins-marketplace.md).
</Tip>
...
* [Use Skills in Claude Code](../01-guides/agent-skills.md)
