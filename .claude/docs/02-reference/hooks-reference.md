...
<Tip>
  For a quickstart guide with examples, see [Get started with Claude Code hooks](../01-guides/hooks.md).
</Tip>
...
[Model Context Protocol (MCP) tools](../01-guides/../01-guides/integration/mcp.md). When MCP servers
...
<Tip>
  For practical examples including code formatting, notifications, and file protection, see [More Examples](../01-guides/hooks.md#more-examples) in the get started guide.
</Tip>
