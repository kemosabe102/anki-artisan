...
For complete plugin testing workflows, see [Test your plugins locally](plugins#test-your-plugins-locally). For technical troubleshooting, see [Plugins reference](plugins-reference.md).
...
- [Plugins reference](../02-reference/plugins-reference.md.md) - Complete technical specifications and schemas
