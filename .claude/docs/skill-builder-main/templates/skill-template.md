...
> **Framework**: [ReACT](../../../docs/00-core/frameworks/analysis.md) - Iterate Reason-Act-Observe to diagnose systematically
...
> **Framework**: [5 Whys](../../../docs/00-core/frameworks/analysis.md) - Ask "why" repeatedly to find root cause
...
When facing complex challenges with this skill, these frameworks guide systematic problem-solving.

**Full Catalog**: [Thinking Frameworks README](../../../docs/00-core/frameworks/README.md)

**Most Relevant for [Skill Domain]**:

| Framework | When to Use |
|-----------|-------------|
| [ReACT](../../../docs/00-core/frameworks/analysis.md) | Multi-step debugging, sequential reasoning |
| [5 Whys](../../../docs/00-core/frameworks/analysis.md) | Root cause investigation |
| [Pre-Mortem](../../../docs/00-core/frameworks/strategy.md) | Risk identification before implementation |

> **Selection Tip**: debugging→ReACT, root cause→5 Whys, optimization→SCAMPER, risk→Pre-Mortem
