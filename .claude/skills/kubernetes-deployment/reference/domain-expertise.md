...
**Purpose**: Core responsibilities, workflow operations, and integration points for deployment-release agent
...
- `development` - Generates Docker image, updates image version
- `code-quality` - Runs pre-deployment unit tests
